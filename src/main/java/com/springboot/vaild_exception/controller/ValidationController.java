...
import com.springboot.vaild_exception.data.dto.ValidatedRequestDto;
...
//        return ResponseEntity.ok(validRequestDto.toString());
//    }
    ...
    public ResponseEntity<String> checkValidation3(@Validated({ValidationGroup1.class,
